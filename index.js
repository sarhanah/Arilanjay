...
*/
const XPTN = 'BEASTARSBOT'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/PutraThebst'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6285719448074'; // Nomor whatsapplu cok
const aktif = '7 jam'; // Kapan bot lu aktif
const groupwa = 'https://chat.whatsapp.com/HSaREkqLNsuIr7g2VMCsOL'; // OFFICIAL GRUP LU 1
const youtube = 'https://chat.whatsapp.com/KOyLjqFGNaWIbaeOHU29nW'; // OFFICIAL GRUP LU 2
//
...
else if (text == 'Beastars'){
conn.sendMessage(id, 'Aku BOT nya Beastars' ,MessageType.text);
}
else if (text == 'Aril'){
...
conn.sendMessage(id, 'PUTRA add Putra wa.me/+6282284623351' ,MessageType.text);
}
